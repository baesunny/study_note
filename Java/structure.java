...
// pblic: 아무나 다 접근할 수 있음. 접근 권한이 all. >> 즉 다른 코드에서도 생성자를 만들 수 있음. 접근 제어의 역할
// num1 이라는 변수를 정수로 지정. 나중에 변수 선언 (실제값 입력)

// public 뒤에는 반환타입이 들어감. void: 반환타입 정해져있지 않음, message: 반환타입 지정
